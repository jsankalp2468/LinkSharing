...
<div class="row">
    ...
    <div class="col-lg-2">
        <img src="${createLink(controller: 'logIn', action: 'show', params: ["name": "${userSubscribedTopics.topic.createdBy.userName}"])}"
             width="80" height="80">
    </div>
    ...
    <div class="col-lg-10">
        <div class="text-primary">
            ...
            <a class="hyperlink"
               href="${createLink(controller: 'topic', ation: 'show', id: userSubscribedTopics.topic.resources[0].id)}">${userSubscribedTopics.topic.name}</a>
        </div>

        <div class="col-lg-4" style="padding-left: 0px">
            <div class="text-muted">@${userSubscribedTopics.topic.createdBy.userName}</div>
            <a href="#" class="hyperlink"><ls:checkSubscribed
                    topicId="${userSubscribedTopics.topic.id}"></ls:checkSubscribed></a>
        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="text-primary"><ls:subscriptionCount
                    topicId="${userSubscribedTopics.topic.id}"></ls:subscriptionCount></div>
        </div>
        ...
        <div class="row">
            <span class="dropdown col-lg-3">
                <g:select id="seriousnessSelect" name="seriousness" from="${enumeration.Seriousness.values()}"
                          optionValue="displayName"
                          optionKey="name"
                          onchange="changeSeriousness(${userSubscribedTopics.id},this.value)"></g:select>
            ...
            <span class="col-lg-7">
                <g:if test="${user.admin || userSubscribedTopics.topic.createdBy == user}">
                    ...
                    <span class="col-lg-3">
                        <a href="${createLink(controller: 'topic',action: 'delete',id: userSubscribedTopics.topic.id)}">
